...
var corn_harvest_scene = preload("res://Croptails_scenes/objects/Plants/corn_harvest.tscn")
var tomato_harvest_scene = preload("res://Croptails_scenes/objects/Plants/tomatoe_harvest.tscn")

@export var diaogue_start_command: String
...
func _unhandled_input(event: InputEvent) -> void:
	if in_range:
		if event.is_action_pressed("show_dialogue"):
			...
			balloon.start(load("res://dialogue/conversations/chest.dialogue"), diaogue_start_command)


func on_feed_the_animals() -> void:
	if in_range:
		trigger_feed_harvest("corn", corn_harvest_scene)
		trigger_feed_harvest("tomatoe", tomato_harvest_scene)
