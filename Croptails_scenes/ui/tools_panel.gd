...
@onready var tool_tomatoe: Button = $MarginContainer/HBoxContainer/ToolTomatoe
...
func _ready() -> void:
	...
	tool_tomatoe.disabled = true
	tool_tomatoe.focus_mode = Control.FOCUS_NONE
...
func _on_tool_tomatoe_pressed() -> void:
...
func on_enable_tool_button(tool: DataTypes.Tools) -> void:
	if tool == DataTypes.Tools.TillGround:
		...
		tool_tomatoe.disabled = false
		tool_tomatoe.focus_mode = Control.FOCUS_ALL
